...
import about from '@/src/assets/images/about/5.png';
      ...
      <section className="lg:py-25 md:py-22.5 pb-17.5">
        <div className="container">
          <div className="relative">
            <Image
              src={about}
              alt="Vallaroo Newsletter - Stay updated with latest features"
              ...
              >
                <div>
                  <h2 className="text-white lg:text-2.5xl md:text-2.5xl text-2xl mb-2.5">
                    Stay Updated with Vallaroo - Get exclusive updates on new features, improvements, and special offers for shop owners.
                  </h2>
                </div>
