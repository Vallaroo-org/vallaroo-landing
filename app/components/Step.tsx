...
import about from '@/src/assets/images/about/2.png';
...
const stepData: StepType[] = [
  {
    ...
    des: 'Sign up in seconds and set up your first shop. Choose from flexible pricing plans that grow with your business.',
  },
  {
    number: '02',
    title: 'Add Products & Inventory',
    des: 'Import your product catalog, set up inventory tracking, and configure pricing across all your shop locations.',
  },
  {
    number: '03',
    title: 'Start Selling',
    des: 'Launch your shop, invite team members, and start processing orders from your B2B partners or B2C customers.',
  },
];
      ...
      <section className="bg-white lg:py-25 md:py-22.5 py-17.5 ">
        <div className="container">
          ...
          >
            ...
            <h2 className="mb-2.5 lg:text-5.5xl md:text-4.6xl text-3.4xl">Launch Your Shop in 3 Simple Steps</h2>
          </div>
